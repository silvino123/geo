...
<div class="row inner_stat">
    <div class="col-lg-7 stats-left-info">
        <div class="row">
            <div class="col-md-6 stats_left counter_grid" data-aos="flip-down">
            
				<i class="far fa-check-circle"></i>
			
                <h4 style="color:#ff6a00">REDES</h4>
                <p>TEXTO</p>
            </div>
            <div class="col-md-6 stats_left counter_grid" data-aos="flip-down">
            <i class="far fa-check-circle"></i>
                <h4 style="color:#ff6a00">HARDWARE</h4>
                <p>TEXTO</p>
            </div>
            <div class="col-md-6 stats_left counter_grid" data-aos="flip-down">
            <i class="far fa-check-circle"></i>
                <h4 style="color:#ff6a00">SOLUCIONES</h4>
                <p>TEXTO</p>
            </div>
            <div class="col-md-6 stats_left counter_grid" data-aos="flip-down">
            <i class="far fa-check-circle"></i>
                <h4 style="color:#ff6a00">INDUSTRIA</h4>
                <p>TEXTO</p>
            </div>
        </div>
    </div>
